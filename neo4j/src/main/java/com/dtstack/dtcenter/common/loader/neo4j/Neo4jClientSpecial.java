...
public class Neo4jClientSpecial implements INeo4j {
    ...
    public List<Map<String, Object>> executeWhatever(ISourceDTO source, String str){
        if (StringUtils.isNotEmpty(str)){
            List<Map<String, Object>> result = Neo4jUtils.execute(source,str);
            return result;
        }
        return null;
    }
...
//        List<Map<String, Object>> result = Neo4jUtils.execute(source, cql, new Object[]{nodeName, labelName, jsonStr, nodeName});
...
//            suffix += " set " + Neo4jUtils.getSuffix(map, true);
//            cql = "start n = node(?) " + suffix + " return n";
//            List<Map<String, Object>> result = Neo4jUtils
...
//        List<Map<String, Object>> result = Neo4jUtils.execute(source, cql, new Object[]{id});
//        return Neo4jUtils.getNode(result);
//    }
//
//    /**
...
//        });
//        sb.append("  return n ");
//        List<Map<String, Object>> execute = Neo4jUtils.execute(source, sb.toString());
...
//        }
//        List<Map<String, Object>> result = Neo4jUtils.execute(source, cql, conds.getObjectArray());
//
...
//        List<Map<String, Object>> result = Neo4jUtils.execute(source, cql,
//                new Object[] { stNodeId });
...
//        List<Map<String, Object>> result = Neo4jUtils.execute(source, cql, new Object[]{nodeId});
//        return Neo4jUtils.getRelas(result);
//    }
